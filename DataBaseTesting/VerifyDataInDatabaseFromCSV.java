...
public class VerifyDataInDatabaseFromCSV {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            while ((line = br.readLine()) != null) {
                ...
                if (!data[0].equals("id")) { // Skip header
                    ...
                    System.out.println("CSV Data - ID: " + id + ", Email: " + email); // Debug statement
    ...
    private static void verifyDataInDatabase(int id, String email) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                System.out.println("Database Email for ID " + id + ": " + dbEmail); // Debug statement
                if (dbEmail.equals(email))
                {
                    System.out.println("Data verified for ID: " + id);
                } else {
